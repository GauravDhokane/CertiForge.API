...
namespace CertiForge.API.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status403Forbidden)]
        [AllowAnonymous]
        public async Task<ActionResult<CourseDto>> GetCourse(int id)// this id and HttpGet id should be same otherwise it will not work and it will give error 500 internal server error
        {
