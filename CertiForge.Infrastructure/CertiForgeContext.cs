...
namespace CertiForge.Infrastructure.Entities;

public partial class CertiForgeContext : DbContext
{
    public CertiForgeContext()
    {
    }

    public CertiForgeContext(DbContextOptions<CertiForgeContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-8CSHHM37\\SQLSERVER2025;Initial Catalog=CertiForge;Integrated Security=SSPI; MultipleActiveResultSets=true;TrustServerCertificate=True;");
